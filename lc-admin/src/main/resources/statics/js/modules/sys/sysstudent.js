$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sys/sysstudent/list',
        datatype: "json",
        colModel: [			
			...
			{ label: '宿舍编号', name: 'stuRoomCode', index: 'stu_room_code', width: 80 }, 			
        ...
        deptTree: function(){
            layer.open({
                ...
                btn1: function (index) {
                    ...
                    //选择上级部门
                    vm.sysStudent.stuRoomCode = node[0].deptCode;
                    vm.sysStudent.stuRoomName = node[0].name;
